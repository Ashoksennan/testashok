...
public class BirthRegistration_First_Fragment extends Fragment implements
    ...
    @Length(max = 12,min = 12, message ="Aadhar Number length should be 12 digit")
    @NotEmpty
    @Nullable
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(Common.isNetworkAvailable(getActivity())){
                    if(et_emailid.getText().toString().endsWith(".com")){
                        validator.validate();
                    }else{
                        Snackbar.make(li_parent_lay,"Enter valid Email ID!",Snackbar.LENGTH_SHORT).show();
                    }
