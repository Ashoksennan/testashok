...
import com.examp.three.activity.Feedback.Feedback;
...
import com.examp.three.activity.faq.FAQ;
...
import com.examp.three.contactUs.ContactUs;
...
//    private DIComponent myComponent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Common.isNetworkAvailable(HomeActivity.this)) {
            ...
            Snackbar.make(drawer, "No Internet Connection !", Snackbar.LENGTH_SHORT).show();
        }
...
//
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent contact_intent = new Intent(HomeActivity.this, Feedback.class);
            startActivity(contact_intent);

        } else if (id == R.id.nav_faq) {

            Intent contact_intent = new Intent(HomeActivity.this, FAQ.class);
            startActivity(contact_intent);
