...
public class BP_RequestStatus_Adapter extends RecyclerView.Adapter<BP_RequestStatus_Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.bars_tv_appNo.setText("" + beanlist.get(position).getApplicationNo());
        holder.bars_tv_status.setText(context.getString(R.string.cStatus) + " " + beanlist.get(position).getStatus());
        holder.bars_tv_date.setText("Date : " + beanlist.get(position).getDate());
        holder.bars_tv_name.setText("Name : " + beanlist.get(position).getName());
        holder.bars_tv_father_name.setText("Father Name : " + beanlist.get(position).getFatherName());
