...
public class PaymentInstantActivity extends AppCompatActivity {
    ...
    RelativeLayout relativeLayout,root_layout;
...
//        mtoolbar = (Toolbar)findViewById(R.id.toolbar);
        ...
        getSupportActionBar().setTitle("Pay Your "+taxType);
...
//                disableText();
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Pay Your Property Tax");
    ...
    private void townPanchayat(Integer districtId) {
        ...
        Log.d(TAG, "townPanchayat: waiting"+API_TOWNPANCHAYAT + districtId);
...
//                    disableText();
    ...
    public final static boolean isValidEmail(CharSequence target) {
        if (target == null) {
            return false;
        }else if(!target.toString().endsWith(".com")){
            return false;
        }
        else {
    ...
    public void getAssessmentDetails() {
        ...
        final JsonArrayRequest request = new JsonArrayRequest(Common.METHOD_NAME_GET_TAX_DETAILS + "?"
...
//                            if (jsonArray != null) {
    ...
    public void getBalanceDetails() {
        String URL_ASSESS_DETAILS =  Common.METHOD_NAME_GET_BAL_BLOCK_DETAILS;
