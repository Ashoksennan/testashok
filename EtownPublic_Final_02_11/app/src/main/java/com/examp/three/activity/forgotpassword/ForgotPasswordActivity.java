...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    public void initViews() {
        ...
        //toolbar
        fp_toolbar = (Toolbar) findViewById(R.id.fp_toolbar);
        setSupportActionBar(fp_toolbar);
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (message.contains("success")) {
                            ...
                            showSnackbar(fp_root_layout, "Email Id is not Registered with Etowns !");
                        }
                    ...
                    Snackbar.make(fp_root_layout, "Cannot Load data from server!", Snackbar.LENGTH_SHORT).show();
                }
            }
